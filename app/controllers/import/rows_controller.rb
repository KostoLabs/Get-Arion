  ...
  private
    ...
    def row_params
      params.require(:import_row).permit(
        :type, :account, :date, :qty, :ticker, :price, :amount,
        :currency, :name, :category, :tags, :entity_type, :notes,
        :asset_customer_id, :asset_description, :asset_qty, :asset_unit,
        :asset_item_value, :asset_value, :asset_place_id, :asset_type,
        :asset_category, :asset_entry_date, :asset_out_date
      )
    end
