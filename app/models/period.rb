class Period
  ...
  def label
    I18n.t("periods.#{key}.label", default: "Custom Period")
  end

  def label_short
    I18n.t("periods.#{key}.label_short", default: "Custom")
  end

  def comparison_label
    I18n.t("periods.#{key}.comparison_label", default: "#{start_date.strftime(@date_format)} - #{end_date.strftime(@date_format)}")
  end
