class Account < ApplicationRecord
  ...
  class << self
    def create_and_sync(attributes)
      ...
      accountable_class = attributes[:accountable_type].constantize rescue nil
        if accountable_class&.respond_to?(:classification)
          account.classification = accountable_class.classification
        end
