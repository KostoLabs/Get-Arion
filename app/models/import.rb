class Import < ApplicationRecord
  TYPES = %w[TransactionImport TradeImport AccountImport MintImport InventoryImport].freeze
  ...
  def display_name
    "Import du #{created_at.strftime('%d/%m/%Y')}"
  end
  ...
  def configuration_partial_name
    case type
    when "AccountImport"
      "account_import"
    when "InventoryImport"
      "inventory_import"
    else
