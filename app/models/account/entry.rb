class Account::Entry < ApplicationRecord
  ...
  scope :account_valuations, -> { where(entryable_type: "Account::Valuation") }
  ...
  def display_name
    return I18n.t("entries.display_names.initial") if name == "Initial Balance"
    return I18n.t("entries.display_names.current") if name == "Current Balance"
  ...
  def update_account_balance_if_valuation
