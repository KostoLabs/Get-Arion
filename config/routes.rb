Rails.application.routes.draw do
  ...
  resources :imports, only: %i[index new show create destroy] do
    ...
    resource :confirm, only: %i[show create], module: :import
    ...
    member do
      ...
      patch :bulk_assign_inventory_mappings
  end
  ...
  resources :financial_liabilities, except: :index
  ...
  namespace :api do
    get "pappers/search", to: "pappers#search"
  end
