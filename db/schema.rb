...
ActiveRecord::Schema[7.2].define(version: 2025_06_19_204831) do
  ...
  create_table "accounts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.decimal "cash_balance", precision: 19, scale: 4, default: "0.0"
    t.virtual "classification", type: :string, as: "\nCASE\n    WHEN ((accountable_type)::text = ANY ((ARRAY['Loan'::character varying, 'CreditCard'::character varying, 'OtherLiability'::character varying, 'FinancialLiability'::character varying])::text[])) THEN 'liability'::text\n    ELSE 'asset'::text\nEND", stored: true
  ...
  create_table "api_pappers", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "siren", null: false
    t.jsonb "response_data", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["siren"], name: "index_api_pappers_on_siren", unique: true
  end
  ...
  create_table "corporates", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.string "naf"
    ...
    t.string "city"
    t.index ["family_id"], name: "index_corporates_on_family_id"
  ...
  create_table "families", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "stripe_premium_plan_id"
    t.string "stripe_premium_subscription_status"
    t.datetime "subscribed_at"
    t.string "stripe_company_plan_id"
    t.string "stripe_company_subscription_status"
  end

  create_table "financial_liabilities", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "lending_type"
    t.string "lending_rate_type"
    t.decimal "lending_rate", precision: 10, scale: 3
    t.date "lending_start"
    t.date "lending_close"
    t.string "lenders"
    t.string "collateral"
    t.decimal "haircut", precision: 10, scale: 3
    t.decimal "collateral_floor", precision: 19, scale: 4
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "import_rows", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "asset_customer_id"
    t.string "asset_description"
    t.string "asset_type"
    t.string "asset_qty"
    t.string "asset_unit"
    t.string "asset_item_value"
    t.string "asset_value"
    t.string "asset_category"
    t.string "asset_entry_date"
    t.string "asset_out_date"
    t.string "asset_place_id"
    t.string "transaction_uuid"
    t.string "asset_customer_place"
    t.uuid "inventory_id"
  ...
  create_table "imports", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.date "valid_at"
    t.string "asset_unit_value_col_label"
    t.string "storage_type_col_label"
    t.string "stock_type_col_label"
    t.string "asset_customer_id_col_label"
    t.string "asset_description_col_label"
    t.string "asset_qty_col_label"
    t.string "asset_unit_col_label"
    t.string "asset_item_value_col_label"
    t.string "asset_value_col_label"
    t.string "asset_place_id_col_label"
    t.string "asset_type_col_label"
    t.string "asset_category_col_label"
    t.string "asset_entry_date_col_label"
    t.string "asset_out_date_col_label"
    t.string "name"
  ...
  create_table "stocks", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "currency"
    t.uuid "import_id", null: false
    t.index ["import_id"], name: "index_stocks_on_import_id"
  end
  ...
  add_foreign_key "corporates", "families"
